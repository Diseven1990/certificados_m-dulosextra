(function(){
  ...
  btn.onclick = async () => {
    ...
    try{
      ...
      const cRgb = (c.style && c.style.textColorRgb) ? c.style.textColorRgb : [1,1,1];
      const textColor = rgb(cRgb[0], cRgb[1], cRgb[2]);
      ...
      // Nota
      {
        ...
        page.drawText(gradeN + "%", { x:f.x, y:f.y, size:f.fontSize, font:fontB, color:textColor });
      }
